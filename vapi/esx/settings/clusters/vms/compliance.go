...
type DeploymentInfo struct {
	...
	//                 hook for the VM.
	///
	LifecycleHook LifecycleHookInfo `json:"lifecycleHook"`

	//
	// Describes the current desired solution specification of the deployment.
	///
	SolutionInfo SolutionInfo `json:"soltuion_info"`
}
...
func (m *Manager) CheckCompliance(ctx context.Context, cluster types.ManagedObjectReference, solution string, filterSpec *CheckComplianceFilterSpec) (*ClusterCompliance, error) {
